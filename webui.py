...
full_auto_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(['OpenAI', 'LLM','阿里云-通义千问', 'Google Translate', 'Bing Translate', 'Ernie'], label='翻译方式', value='LLM'),
        gr.Dropdown(['简体中文', '繁体中文', 'English', 'Cantonese', 'Japanese', 'Korean'], label='目标语言', value='简体中文'),

        gr.Dropdown(['xtts', 'cosyvoice', 'EdgeTTS','F5-TTS'], label='AI语音生成方法', value='xtts'),
