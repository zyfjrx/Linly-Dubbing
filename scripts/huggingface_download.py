...
snapshot_download('jonatasgrosman/wav2vec2-large-xlsr-53-chinese-zh-cn',local_dir="/home/bmh/Linly-Dubbing/models/ASR/whisper/jonatasgrosman", resume_download=True, local_dir_use_symlinks=False)
